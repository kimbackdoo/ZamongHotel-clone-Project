...
.sub3_div3 { background: url("/m/images/sub3_1/sub3_1.jpg") no-repeat center top; height: 170px; }
.sub3_div4 { background: url("/m/images/sub3_1/sub3_2.jpg") no-repeat center top; height: 277px; }
</style>

<div class="sub3_1_div1"><p>Front</p></div>

<div class="sub3_1_div2">
	<div class="swiper-container swiper-sub3-1" >
		 <div class="swiper-wrapper">
			<?for($i=1; $i<=5; $i++){?>
				<div style="background:url('/m/images/sub3_1/<?=$i?>.jpg');width:100%;background-position:center center;" class="swiper-slide" ></div>
			<?}?>
		</div>
		 ...
		 <div class="swiper-wrapper">
			<?for($i=1; $i<=5; $i++){?>
				<div class="swiper-slide" >
					<img src="/m/images/sub3_1/<?=$i?>.jpg" alt="방 풍경" />
