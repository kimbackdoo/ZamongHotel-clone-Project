...
.sub2_div3 { background: url("/m/images/sub2_1/sub2_1.jpg") no-repeat center top; height: 311px; }

.sub2_div4 { width: 100%; height: 125px; }
.sub2_div4 > a > img { display: block; margin: 0 auto; padding-top: 40px; }

.sub2_div5 { background: url("/m/images/sub2_1/sub2_2.jpg") no-repeat center top; height: 808px; }
</style>

<div class="sub2_1_div1"><p>Deluxe Double</p></div>

<div class="sub2_1_div2">
	<div class="swiper-container swiper-sub2-1" >
		 <div class="swiper-wrapper">
			<?for($i=1; $i<=11; $i++){?>
				<div style="background:url('/m/images/sub2_1/<?=$i?>.jpg');width:100%;background-position:center center;" class="swiper-slide" ></div>
			<?}?>
		</div>
		 ...
		 <div class="swiper-wrapper">
			<?for($i=1; $i<=11; $i++){?>
				<div class="swiper-slide" >
					<img src="/m/images/sub2_1/<?=$i?>.jpg" alt="방 풍경" />
